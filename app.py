...
@st.cache_data
def load_data():
    return load_and_preprocess_data('Blue Pacific 2050_ Technology And Connectivity (Thematic Area 7) data.csv')
...
with st.sidebar:
    ...
    selected_countries = st.multiselect(
        "Pilih Negara:",
        options=countries,
        default=['Cook Islands', 'Samoa', 'Fiji']
    )
...
try:
    ...
    st.warning("Gagal memuat file CSS kustom")